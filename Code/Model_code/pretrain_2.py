...
from Dataset_2_pre import Graph_Bert_Dataset
import time
import os
...
large = {'name': 's_ab_128_data_s2', 'num_layers': 3, 'num_heads': 2, 'd_model': 128, 'path': 'large_weights','addH':True}
...
train_dataset, test_dataset = Graph_Bert_Dataset(path='./S_AB.csv',smiles_field='SMILES',addH=addH).get_data()
